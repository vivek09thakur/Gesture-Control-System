...
def interpolate(current, target, factor):
    # using interpretation to get smooth output
    t = factor
    return int(current + (target - current) * (1 - (1 - t) * (1 - t)))
    ...
    if results.multi_hand_landmarks:
        ...
        if abs(index_y - thumb_y) < 20:
            ...
            if prev_index_x is None:
                ...
                pyautogui.moveTo(new_x, new_y, duration=0.05, tween=pyautogui.easeOutQuad)
